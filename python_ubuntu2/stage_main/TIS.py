...
class TIS:
    ...
    def _createPipeline(self):
        ...
        # Query a pointer to the appsink,
        # so we can assign the callback function.
    ...
    def Snap_image(self, timeout):
        ...
        if (self.sample is not None and self.newsample is True):
            self.__convert_sample_to_numpy()
            return True
        return False
    ...
    def selectDevice(self):
        ...
        for single_serial in serials:
            (
                ...
                model,
                identifier,
                connection_type) = source.get_device_info(single_serial)
    ...
    def selectFormat(self):
        ...
        self.openDevice(self.serialnumber, width, height,
                        framerate, SinkFormats.BGRA, True)
        return True
